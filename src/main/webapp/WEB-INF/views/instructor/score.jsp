								...
								<table id=""
									...
									<tbody>
										...
										<tr>
											...
											<td><a href="${pageContext.request.contextPath}/instructor/score/studentlist?os_id=${l.os_id}"><button type="button" class="btn btn-info btn-sm">확인</button></a></td>
										</tr>
										</c:forEach>
										</c:if>
										<c:if test="${score_osList_count==0}">
											<tr><td colspan="12">성적 관리 가능한 과목이 없습니다</td></tr>
										</c:if>										
									</tbody>
								</table>
							</div>
