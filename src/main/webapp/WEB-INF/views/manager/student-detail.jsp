				...
				<div class="page-header float-right">
					<div class="page-title">
						<ol class="breadcrumb text-right">
							<li><a href="${pageContext.request.contextPath}/manager/student">수강생
									관리</a></li>
							<li class="active">수강생 상세보기</li>
						</ol>
					</div>
				</div>
			</div>
			...
			<div class="animated fadeIn">
				<div class="row">
					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-header">
								<strong class="card-title">수강생 ${studentInfo.student_id}(${studentInfo.name_}/${studentInfo.ssn})의 기본 정보</strong>
							</div>
							<div class="card-body">
					...
					<div class="col-md-12">
						<div class="card">
							<div class="card-header">
								<strong class="card-title">수강생 ${studentInfo.student_id}(${studentInfo.name_}/${studentInfo.ssn})의 수강 과정 목록</strong>
							</div>
							<div class="card-body">
								<table id="" class="table table-striped table-bordered">
									<thead>
