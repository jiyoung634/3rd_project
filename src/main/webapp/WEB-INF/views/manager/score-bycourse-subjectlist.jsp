						...
						<div class="card">
							<div class="card-header">
								<strong class="card-title">${ocInfo.oc_title}(<df:dateForm date="${ocInfo.oc_start_date}" />~
														<df:dateForm date="${ocInfo.oc_end_date}" />)의 성적 조회</strong>
							</div>
							<div class="card-body">
										...
										<c:forEach var="c" items="${subjectList}">
												...
												<tr>
													...
													<td><p class="tt instructor-profile">
														...
														src="${pageContext.request.contextPath}/resources/uploads/pictures/${c.profile_img}" alt="instructor">강의가능과목<br>${c.available_subjects}
																</span>
														</p>
													</td>
													...
													<td><button type="button" class="btn btn-info btn-sm btn-ss-check" value="${c.os_id}" ${(c.attendance_percentage==0 || c.exam_date==null)?"disabled":""}>확인</button></td>
												</tr>
